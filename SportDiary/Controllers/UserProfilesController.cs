...
namespace SportDiary.Controllers
{
    public class UserProfilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age")] UserProfile userProfile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age")] UserProfile userProfile)
        {
